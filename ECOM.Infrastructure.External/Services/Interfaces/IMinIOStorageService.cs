...
namespace ECOM.Infrastructure.External.Services.Interfaces
{
	public interface IMinIOStorageService
	{
		...
		/// </summary>
		Task<UploadFileResult> UploadAsync(string bucketName, string objectName, byte[] data, string contentType);
